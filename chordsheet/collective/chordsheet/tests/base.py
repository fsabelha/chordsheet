...
def setup_product():
    ...
    import collective.chordsheet
    zcml.load_config('configure.zcml', collective.chordsheet)
    ...
    ztc.installPackage('collective.chordsheet')
...
setup_product()
ptc.setupPloneSite(products=['collective.chordsheet'])
